      ...
      <div className="grid grid-cold-1 lg:grids-cols-12">
        <div className="col-span-7 place-self-center text-center sm:text-left">
          ...
          <div>
            <Link
              href="/contactMe"
              className="px-6 inline-block py-3 w-full sm:w-fit rounded-full mr-4 bg-gradient-to-br from-[#CDFADB] to-[#CDFADB] text-white"
            >
              Hire Me
            </Link>
            <Link
              href="/Giselle'sResume.pdf"
              className="px-1 inline-block py-1 w-full sm:w-fit rounded-full bg-gradient-to-br from-[#CDFADB] to-[#CDFADB] text-white mt-3"
            >
